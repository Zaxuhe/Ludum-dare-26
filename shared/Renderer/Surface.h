...
public:
	...
	//This one repeats the texture :)
	void Surface::BlitEx2_zax(rtRectf dst, rtRectf src, CL_Vec2f displacement = CL_Vec2f(0,0), unsigned int rgba = MAKE_RGBA(255,255,255,255), float rotationDegrees = 0, CL_Vec2f vRotatePt = CL_Vec2f(0,0));
