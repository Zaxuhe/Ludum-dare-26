...
#ifndef TouchHandlerComponent_Zax_h__
#define TouchHandlerComponent_Zax_h__
 ...
 */
class TouchHandlerComponent_Zax: public EntityComponent
{
public:
	TouchHandlerComponent_Zax();
	virtual ~TouchHandlerComponent_Zax();
...
#endif // TouchHandlerComponent_Zax_h__
