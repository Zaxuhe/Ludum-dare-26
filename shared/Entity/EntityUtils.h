...
EntityComponent * MorphToVec2EntityZax(Entity *pEnt, string targetVar, CL_Vec2f vTargetSize, unsigned int speedMS, eInterpolateType interpolateType = INTERPOLATE_SMOOTHSTEP,  int delayBeforeActionMS = 0);
...
EntityComponent * MorphToColorEntity_Zax(Entity *pEnt, std::string component_name_, unsigned int color, int timeMS, int delayBeforeActionMS = 0);
