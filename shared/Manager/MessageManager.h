...
public:
	...
	//Zaxuhe
	bool m_stop_on_pause_;
	bool checked_; //has been moved already
	unsigned int paused_diff_;
...
public:
	...
	void CallEntityFunctionZax( Entity *pEnt, int timeMS, const string &funcName, const VariantList *v = NULL, bool pauses_game = false, eTimingSystem timing = GetTiming());
	...
	void pause_game(bool _state); //true is paused false is not paused
